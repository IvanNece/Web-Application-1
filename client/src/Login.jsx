      ...
      <div className="test-accounts">
        ...
        <div className="account-item">
          <div className="account-info">
            <div className="account-username">novice</div>
            <div className="account-password">password: password</div>
          </div>
          <div className="account-coins">100 monete</div>
        </div>
        <div className="account-item">
          <div className="account-info">
            <div className="account-username">player</div>
            <div className="account-password">password: password</div>
          </div>
          <div className="account-coins">Con partite già giocate</div>
        </div>
      </div>
    </div>
  );
